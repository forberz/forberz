...
--
-- Host: localhost:3306
-- Generation Time: Sep 09, 2017 at 05:02 AM
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `buyshortterm_en` text,
  `buyshortterm_he` text,
  `buyshortterm_ru` text,
  `buybtn_en` varchar(255) DEFAULT NULL,
  `buybtn_he` varchar(255) DEFAULT NULL,
  `buybtn_ru` int(255) DEFAULT NULL,
  `ammount_en` int(4) DEFAULT NULL,
  `ammount_he` int(4) DEFAULT NULL,
  `ammount_ru` int(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(3, 32, 'Israel', 'צפון', 'Израиль', 'Kiryat Bialik', 'קריית ביאליק', 'Кирят Биялик', 'California Auto Spa', 'California Auto Spa', 'California Auto Spa', 'HaHaroshet 60', 'החרושת 60', 'ХаХарошет 60', '058-6336233'),
(4, 12, 'Israel', 'דרום', 'Израиль', 'Be\'er Sheva', 'באר שבע', 'Бе\'ер Шева', 'Car Wash', 'Car Wash', 'Car Wash', 'HaPlada 18', 'הפלדה 18', 'ХаПлада 18', '052-8208143'),
