...
<div class="buy">
	<div class="buy_rideeffect">
		<h2>Forberz Ride Effect - פורברז רייד אפקט</h2>
		<h3>משחת שחזור, חידוש וטיפוח לפלסטיק וגומי</h3>
	...
	<div class="buy_detailhd">
		<h2>Forberz DetailHD - פורברז דיטייל אייצ' די</h2>
		<h3>תרסיס ניקוי לעור, בד ופלסטיק</h3>
		<img class="black_img" src="img/forberz_detail_hd_front.jpg" alt="Forberz - Natural Care and Detailing Products for Cars and Bikes" width="250px">
		<p></br><b>- מנקה ביעילות ובמהירות כתמים שונים, לכלוך, שומנים ועוד.
		</br>- אינו פוגע במשטח המטופל או במשטחים הסובבים.
		</br>- מחטא את המשטח המטופל ומסייע בהסרת עובש וריחות שונים.
		</br>- אינו מכיל אלכוהול או חומצות חזקות.</b>
		</br></br>נוזל מחומרים טבעיים לניקוי יסודי בקלות בעזרת מטלית או מברשת. ללא צורך בהתזה על המשטח. מעולה לניקוי מוש
		בי עור, ניקוי ריפודי בד בבית וברכב וניקוי ריפודים שונים כגון התקרה ודיפוני הדלתות ברכב. מומלץ כנקיון רא
		שוני לפני יישום חומרי שחזור וטיפוח.מתאים למגוון משטחים ושימושים בבית, ברכב, בעבודות שונות ועוד. 
		</br></br><b>100% טבעי, אינו רעיל, ללא סיליקון, ללא רכיבים מן החי, בטוח לשימוש בחדרי צביעה ומוסכי פחחות.</b></p>
		<form class="payment_btn" id="detailhd" name="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
			<input type="hidden" name="cmd" value="_xclick">
			<input type="hidden" name="business" value="sales@forberz.com">
			<input type="hidden" name="cpp_header_image" value="https://i.imgur.com/LYmEIWe.png">
			<input type="hidden" name="cpp_payflow_color" value="000039">
			...
			<input type="hidden" name="currency_code" value="ILS">
			<input type="hidden" name="lc" value="US">
			<input type="hidden" name="item_name" value="Forberz™ DetailHD 500ml - חומר ניקוי לעור,בד ופלסטיק">
			<input type="hidden" name="item_number" value="9">
			<!-- <input type="hidden" name="invoice" value="5906270250f"> -->
			<input type="hidden" name="no_shipping" value="1">
			<input type="hidden" name="amount" value="100.00">
			<input type="hidden" name="shipping" value="0">
			<span><b>100 ש"ח</b></span>
			<input type="submit" value="קנה עכשיו">
			<span>כמות</span>
			<input type="number" name="quantity" value="1" id="quantity" min="1" pattern="[0-9]*">
			<input type="hidden" name="return" value="http://www.forberz.com/#thank-you">
