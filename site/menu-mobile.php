<header class="mobile-header">
	<div class="mobile_black_wrap">
		<div class="top">
			<div id="menu-opener" onclick="$('#menu-opener,div.main_menu').toggleClass('close')">&nbsp;</div>
			<a href="/">
				<img class="mobile-logo" height="32" src="img/forberz.png" alt="Forberz - Natural Care and Detailing Products for Cars and Bikes" />
			</a>
		</div>
...
<?php
if ($current_page) {
	echo '<p class="spacer">&nbsp;</p><p class="spacer">&nbsp;</p>';
}
?>